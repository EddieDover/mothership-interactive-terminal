...
async function compileSass() {
  const scssFile = path.join(SRC_DIR, "styles", "fvtt-mii.scss");
  const cssOutputFile = path.join(DIST_DIR, "styles", "fvtt-mii.css");
...
async function createZip() {
  const packageName = "mothership-interactive-terminal.zip";
